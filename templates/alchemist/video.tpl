  ...
  <body>
    ...
    <main class="container">
      <hgroup>
        ...
        <nav aria-label="breadcrumb">
          <ul>
            ...
            {% endif %}
            {% if file %}
            <li><a href="{{ archivesspace_public_url | trim('/') }}{{ file_uri }}">{{ file }}</a></li>
            {% endif %}
            <li>
              <a href="{{ archivesspace_public_url | trim('/') }}{{ archival_object_uri }}" title="open the {{ title }} collection guide metadata record">
                ...
                </span><span class="visually-hidden">open the {{ title }} collection guide metadata record</span>
              </a>
            </li>
          </ul>
        </nav>
      ...
      <video style="width:100%" controls>
        <source src="{{ iiif_manifest_url }}" type="video/mp4" />
      </video>
      <dl id="metadata">
        <dt>Title</dt>
        <dd>{{ title }}</dd>
